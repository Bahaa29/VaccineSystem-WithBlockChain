   ...
   <div class="row">
    <div class="col-md-6" style="margin:0 auto;margin-top:20px;">
        <form @submit.prevent="createPost" id="MOH_Track_FORM">
            <input class="form-control search_txt" type="text" v-model="formData.id" placeholder="Vaccine ID"/>
            <input class="form-control search_txt" type="text" v-model="formData.name" placeholder="Vaccine Name"/>
            <input class="btn btn-success btn_search" type="submit" value="GET"/>
        </form>
    </div>
    </div>
